...
public class EuclideanDisntanceRecommendarTest {

    @Test
    public void type() throws Exception {
        assertNotNull(EuclideanDisntanceRecommendar.class);
    }

    @Test
    public void instantiation() throws Exception {
        Recommender target = new EuclideanDisntanceRecommendar();
        assertNotNull(target);
    }

    @Test
    public void getSimilarity_A$Person$Person() throws Exception {
        Recommender recommender = new EuclideanDisntanceRecommendar();
